...
<script type="text/javascript">
      ...
      function onLoad() {
        ...
        // 'transliterateDiv'.
         if($("#disname").length){
            control.makeTransliteratable(['disname']);
        }
		/* if($("#s_name").length){
...
<div class="row">
	<div class="col-lg-offest-6 col-lg-6 col-md-offset-3 col-md-6">
	  <form  method="POST" action="add_district2.php">
      <?php
      ...
      if (isset($_GET["err"]))
                ...
                if (isset($_GET["msg"]))
                {
                  echo"<div class='alert alert-warning' role='alert' style='width=20%
                      background: #dddddd;border-radius:15px;font-size:20px;vertical-align:center; text-align: center;''>";
                  echo "<b> જિલ્લાનું નામ અંદર છે જ";
                  echo"</div>";
                }
              ...
              if (isset($_GET["erro"]))
                {
                  echo"<div class='alert alert-danger' role='alert' style='width=20%
                      background: #dddddd;border-radius:15px;font-size:20px;vertical-align:center; text-align: center;''>";
                  echo "<b>જિલ્લાનું નામ નાકાહાયુ નથી";
                  echo"</div>";
                }
      ...
      ?>
			...
			<div class="input-group">
		      ...
		      <input id="disname" type="text" class="form-control" name="disname" placeholder="જિલ્લાનું નામ નાખો" onchange="isalpha(this)" required>
		    </div>
		     <br><div>
