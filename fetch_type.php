...
<?php
			...
			$qr="select * from  planttype";
			$qry=mysql_query($qr);
			$count=0;
			  echo"<table class='table table-bordered'>";		
		   echo"<thead style='background-color:#660000;color:#ffffff;'><tr><th>No</th><th>Plant Type</th><th></th></tr></thead>";
		   while($ar=mysql_fetch_assoc($qry))
			  {
				...
				echo "<td>".$count."</td>";
				//cho"<td>".$ar["$count"]."</td>";
				echo"<td>".$ar["type_name"]."</td>";
				echo "<td><a href='delete_type.php?no=".$ar["type_id"]."'  onclick='return check();'>રદ કરવા</a></td>";
